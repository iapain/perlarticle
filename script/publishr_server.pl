...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{PUBLISHR_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{PUBLISHR_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
publishr_server.pl - Catalyst Testserver

=head1 SYNOPSIS

publishr_server.pl [options]
